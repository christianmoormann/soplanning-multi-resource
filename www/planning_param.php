...
if(isset($_COOKIE['filtreStatutTache'])) {
	$_SESSION['filtreStatutTache'] = json_decode(base64_decode($_COOKIE['filtreStatutTache']));
...
if(isset($_COOKIE['filtreStatutProjet'])) {
	$_SESSION['filtreStatutProjet'] = json_decode(base64_decode($_COOKIE['filtreStatutProjet']));
