	...
	<div class="soplanning-box form-inline pt-0" id="divPlanningMainFilter">
		...
		<div id="moreActions">
			...
			<div class="btn-group pt-2" id="dropdownLarge">
				...
				{/if}
				<button class="btn dropdown-toggle btn-default" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-sort fa-lg fa-fw" aria-hidden="true"></i>&nbsp;<span class="caret"></span></button>
				<div class="dropdown-menu">						
					{if $fleches eq '1'}
...
<div class="d-nonez dropdown" id="dropdownDisplayPlanning">
