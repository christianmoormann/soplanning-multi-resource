...
$retentionDays = (int)CONFIG_SOPLANNING_OPTION_AUDIT_RETENTION;
if ($retentionDays < 1) { $retentionDays = 365; }
$sqlPurge = "DELETE FROM planning_audit WHERE date_modif <= DATE_ADD(CURDATE(), INTERVAL -$retentionDays DAY);";
