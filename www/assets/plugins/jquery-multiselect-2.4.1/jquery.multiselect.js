    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            if( instance.options.maxHeight ) {
                ...
                var maxHeight = (window.innerHeight - optionsWrap[0].getBoundingClientRect().top - 20);
            }
            ...
            // Bloquer le scroll de la page quand le curseur est sur le dropdown
            // passive:false obligatoire pour que preventDefault() fonctionne
            optionsWrap[0].addEventListener('wheel', function(e) {
                e.preventDefault();
                // Si le dropdown est scrollable, le scroller manuellement
                if( this.scrollHeight > this.clientHeight ) {
                    var delta = e.deltaY;
                    if( e.deltaMode === 1 ) delta *= 40;  // lignes → pixels
                    if( e.deltaMode === 2 ) delta *= this.clientHeight; // pages → pixels
